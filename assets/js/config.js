...
export const DEFAULT_STORAGE_FILE_NAME = 'weblinks.json';

/** localStorage key for persisted UI settings */
export const LS_SETTINGS_KEY = 'dashboard_settings';

/** localStorage key for persisted sync fingerprint */
export const LS_SYNC_HASH_KEY = 'dashboard_sync_hash';

/** localStorage key for the active storage mode ('direct' | 'manual') */
export const LS_STORAGE_MODE_KEY = 'dashboard_storage_mode';

/** localStorage key for the last connected JSON file name */
export const LS_STORAGE_FILE_NAME_KEY = 'dashboard_storage_file_name';

/** localStorage key for manual-mode file identity metadata (name, size, lastModified) */
export const LS_STORAGE_FILE_META_KEY = 'dashboard_storage_file_meta';

/** IndexedDB database name used to persist the file handle */
export const IDB_DB_NAME = 'dashboard-storage';
...
export const IDB_HANDLE_KEY = 'mainHandle';

/** IndexedDB key used to cache the last loaded bookmark data */
export const IDB_DATA_KEY = 'cachedData';

/** IDs of the protected default categories */
export const DEFAULT_CATEGORY_IDS = Object.freeze({
